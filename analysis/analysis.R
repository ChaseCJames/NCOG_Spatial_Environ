...
result_tables_anom <- function(input = "data/16s_cyanos.Rdata", som_file = "output/cyano_16s_surf_som.Rdata.Rdata",
                          SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
                          physical_data = "data/surface_samples_w_anoms.csv",
                          map_file = "output/cyano_16s_surf_map.Rdata", regression_file = "output/cyano_16s_surf_glm_anom.Rdata",
                          dissimmilar_matrix = "output/cyano_16s_surf_dissimilar.Rdata", 
                          full_data_file = "output/cyano_16s_surf_anom_full_data.Rdata",
                          sample_regime = "surface"){
  ...
  data <- physical_dat[colnames(physical_dat)[c(2,33:41,46:47)]]
  ...
  som_maps <- full_dat %>% 
    ...
    summarise(som_1 = sum(som_id == 1, na.rm = TRUE)/n(), som_2 = sum(som_id == 2, na.rm = TRUE)/n(),
              ...
              SiO3_mean = mean(SiO3ug, na.rm = TRUE), C14_mean = mean(IntC14, na.rm = TRUE),
              MLD_mean = mean(MLD_Sigma, na.rm = TRUE), NC_mean = mean(NCDepth, na.rm = TRUE),
              temp_anom_mean = mean(T_degC_season_anom, na.rm = TRUE), sal_anom_mean = mean(Salnty_season_anom, na.rm = TRUE), 
              PO4_anom_mean = mean(PO4_season_anom, na.rm = TRUE), SiO3_anom_mean = mean(SiO3_season_anom, na.rm = TRUE), 
              NO3_anom_mean = mean(NO3_season_anom, na.rm = TRUE), 
              temp_season_mean = mean(T_degC_season_mean, na.rm = TRUE), sal_season_mean = mean(Salnty_season_mean, na.rm = TRUE), 
              PO4_season_mean = mean(PO4_season_mean, na.rm = TRUE), SiO3_season_mean = mean(SiO3_season_mean, na.rm = TRUE), 
              NO3_season_mean = mean(NO3_season_mean, na.rm = TRUE), 
              temp_coeff = sd(T_degC, na.rm = TRUE)/mean(T_degC, na.rm = TRUE),
              sal_coeff = sd(Salnty, na.rm = TRUE)/mean(Salnty, na.rm = TRUE),
              PO4_coeff =  sd(PO4ug, na.rm = TRUE)/mean(PO4ug, na.rm = TRUE),
              NO3_coeff = sd(NO3ug, na.rm = TRUE)/mean(NO3ug, na.rm = TRUE),
              ...
              MLD_coeff = sd(MLD_Sigma, na.rm = TRUE)/mean(MLD_Sigma, na.rm = TRUE),
              NC_coeff = sd(NCDepth, na.rm = TRUE)/mean(NCDepth, na.rm = TRUE),
              temp_anom_coeff = sd(T_degC_season_anom, na.rm = TRUE)/mean(T_degC_season_anom, na.rm = TRUE), 
              sal_anom_coeff = sd(Salnty_season_anom, na.rm = TRUE)/mean(Salnty_season_anom, na.rm = TRUE), 
              PO4_anom_coeff = sd(PO4_season_anom, na.rm = TRUE)/mean(PO4_season_anom, na.rm = TRUE), 
              SiO3_anom_coeff = sd(SiO3_season_anom, na.rm = TRUE)/mean(SiO3_season_anom, na.rm = TRUE), 
              NO3_anom_coeff = sd(NO3_season_anom, na.rm = TRUE)/mean(NO3_season_anom, na.rm = TRUE), 
              evenness = mean(evenness, na.rm = TRUE), shannon = mean(shannon, na.rm = TRUE),
              richness = mean(richness, na.rm = TRUE)
    )
...
# 16s cyanos
set.seed(5)
result_tables_anom(input = "data/16s_cyanos.Rdata", som_file = "output/cyano_16s_surf_som.Rdata",
              SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
              physical_data = "data/surface_samples_w_anoms.csv",
              map_file = "output/cyano_16s_surf_anom_map.Rdata", regression_file = "output/cyano_16s_surf_glm_anom.Rdata",
              dissimmilar_matrix = "output/cyano_16s_surf_dissimilar.Rdata", 
              full_data_file = "output/cyano_16s_surf_anom_full_data.Rdata",
              sample_regime = "surface")
...
# 16s minus eukaryotes and plastids
set.seed(192)
result_tables_anom(input = "data/16s_bacteria_m_euks.Rdata", som_file = "output/bacteria_m_euks_16s_surf_som.Rdata",
              SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
              physical_data = "data/surface_samples_w_anoms.csv",
              map_file = "output/bacteria_m_euks_16s_surf_anom_map.Rdata", regression_file = "output/bacteria_m_euks_16s_surf_glm_anom.Rdata",
              dissimmilar_matrix = "output/bacteria_m_euks_16s_surf_dissimilar.Rdata", 
              full_data_file = "output/bacteria_m_euks_16s_surf_anom_full_data.Rdata",
              sample_regime = "surface")

# 18sv9 Autotrophic Eukaryotes
set.seed(15)
result_tables_anom(input = "data/18s_autotrophic_euks.Rdata", som_file = "output/euks_auto_18sv9_surf_som.Rdata",
              SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
              physical_data = "data/surface_samples_w_anoms.csv",
              map_file = "output/euks_auto_18sv9_surf_anom_map.Rdata", regression_file = "output/euks_auto_18sv9_surf_glm_anom.Rdata",
              dissimmilar_matrix = "output/euks_auto_18sv9_surf_dissimilar.Rdata", 
              full_data_file = "output/euks_auto_18sv9_surf_anom_full_data.Rdata",
              sample_regime = "surface")

# 18sv9 Eukaryotes
set.seed(987)
result_tables_anom(input = "data/18s_heterotrophic_euks.Rdata", som_file = "output/euks_hetero_18sv9_surf_som.Rdata",
              SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
              physical_data = "data/surface_samples_w_anoms.csv",
              map_file = "output/euks_hetero_18sv9_surf_anom_map.Rdata", regression_file = "output/euks_hetero_18sv9_surf_glm_anom.Rdata",
              dissimmilar_matrix = "output/euks_hetero_18sv9_surf_dissimilar.Rdata", 
              full_data_file = "output/euks_hetero_18sv9_surf_anom_full_data.Rdata",
              sample_regime = "surface")


######### K Means Analysis ########

result_tables_kmeans <- function(input = "data/16s_bacteria.Rdata", kmeans_file = "output/bacteria_16s_kmeans.Rdata",
                          SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
                          physical_data = "data/NCOG_sample_metadata.csv",
                          map_file = "output/bacteria_16s__kmean_map.Rdata", regression_file = "output/bacteria_16s_kmean_glm.Rdata",
                          dissimmilar_matrix = "output/bacteria_16s_kmean_dissimilar.Rdata", 
                          full_data_file = "output/bacteria_16s_kmean_full_data.Rdata",
                          sample_regime = "both"){
  ...
  eco.kmeans <- kmeans(scaled_inputs, centers = 2, nstart = 100, iter.max = 100000)
  
  save(eco.kmeans, file = kmeans_file)
  
  clusters <- eco.kmeans$cluster
  
  asv_copy$som_id <- clusters
  ...
  som_maps <- full_dat %>% 
    ...
    summarise(som_1 = sum(som_id == 1, na.rm = TRUE)/n(), som_2 = sum(som_id == 2, na.rm = TRUE)/n(),
              ...
              SiO3_mean = mean(SiO3ug, na.rm = TRUE), C14_mean = mean(IntC14, na.rm = TRUE),
              MLD_mean = mean(MLD_Sigma, na.rm = TRUE), NC_mean = mean(NCDepth, na.rm = TRUE),
              Chl_mean = mean(ChlorA, na.rm = TRUE), Dist_mean = mean(dist_to_coast, na.rm = TRUE),
              temp_coeff = sd(T_degC, na.rm = TRUE)/mean(T_degC, na.rm = TRUE),
              sal_coeff = sd(Salnty, na.rm = TRUE)/mean(Salnty, na.rm = TRUE),
              PO4_coeff =  sd(PO4ug, na.rm = TRUE)/mean(PO4ug, na.rm = TRUE),
              NO3_coeff = sd(NO3ug, na.rm = TRUE)/mean(NO3ug, na.rm = TRUE),
...
set.seed(124)
result_tables_kmeans(input = "data/16s_cyanos.Rdata", kmeans_file = "output/cyano_16s_kmeans.Rdata",
                     SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
                     physical_data = "data/NCOG_sample_metadata.csv",
                     map_file = "output/cyano_16s_kmean_map.Rdata", regression_file = "output/cyano_16s_kmean_glm.Rdata",
                     dissimmilar_matrix = "output/cyano_16s_kmean_dissimilar.Rdata", 
                     full_data_file = "output/cyano_16s_kmean_full_data.Rdata",
                     sample_regime = "both")

set.seed(9)
result_tables_kmeans(input = "data/16s_bacteria_m_euks.Rdata", kmeans_file = "output/bact_m_euks_16s_kmeans.Rdata",
                     SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
                     physical_data = "data/NCOG_sample_metadata.csv",
                     map_file = "output/bact_m_euks_16s_kmean_map.Rdata", regression_file = "output/bact_m_euks_16s_kmean_glm.Rdata",
                     dissimmilar_matrix = "output/bact_m_euks_16s_kmean_dissimilar.Rdata", 
                     full_data_file = "output/bact_m_euks_16s_kmean_full_data.Rdata",
                     sample_regime = "both")

set.seed(875)
result_tables_kmeans(input = "data/18s_autotrophic_euks.Rdata", kmeans_file = "output/euks_auto_18sv9_kmeans.Rdata",
                     SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
                     physical_data = "data/NCOG_sample_metadata.csv",
                     map_file = "output/euks_auto_18sv9_kmean_map.Rdata", regression_file = "output/euks_auto_18sv9_kmean_glm.Rdata",
                     dissimmilar_matrix = "output/euks_auto_18sv9_kmean_dissimilar.Rdata", 
                     full_data_file = "output/euks_auto_18sv9_kmean_full_data.Rdata",
                     sample_regime = "both")

set.seed(343)
  result_tables_kmeans(input = "data/18s_heterotrophic_euks.Rdata", kmeans_file = "output/euks_hetero_18sv9_kmeans.Rdata",
                     SST_data = "output/CALCOFI_temp_tables.Rdata", SLA_data = "output/CALCOFI_sla_tables.Rdata",
                     physical_data = "data/NCOG_sample_metadata.csv",
                     map_file = "output/euks_hetero_18sv9_kmean_map.Rdata", regression_file = "output/euks_hetero_18sv9_kmean_glm.Rdata",
                     dissimmilar_matrix = "output/euks_hetero_18sv9_kmean_dissimilar.Rdata", 
                     full_data_file = "output/euks_hetero_18sv9_kmean_full_data.Rdata",
                     sample_regime = "both")
