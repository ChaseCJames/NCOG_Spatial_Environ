...
fig_2_func <- function(in_list = plot_list, file_name = "figures/figure_outline/surface_only_plots/fig_2_surf.pdf", tsize  = 12){
...
fig_3_func <- function(file_name = "figures/figure_outline/surface_only_plots/fig_3_surf.pdf", tsize = 12){
  
  cyano <- regression_figure(glm_file = "output/cyano_16s_surf_glm.Rdata",
                             map_file = "output/cyano_16s_surf_map.Rdata",   
                             figure_name = "figures/glm_plots/cyano_16s_som_surface_",
                             main = "16s Cyanobacteria", cluster2 = "Offshore", cluster1 = "Nearshore",
  ...
  aic_plot <- full_aic_table_figure(in_group_list = c("archaea_16s_surface","bacteria_m_euks_16s_surface", "cyano_16s_surface","euks_auto_18sv9_surface",
                                                      "euks_hetero_18sv9_surface"),
                                    in_group_names = c("Archaea","Bacteria", "Cyanobacteria", "Photosynthetic Eukaryotic\nProtists",
                                                       "Heterotrophic\nEukaryotic Protists"),
                                    minimum_tp = 4, width_plot = 10,
                                    figure_name_2 = paste0("figures/aic_figures/big_group_aic_plot_logit_surface",".pdf"),
...
fig_4_func <- function(file_name = "figures/figure_outline/surface_only_plots/fig_4_surf.pdf",
                       in_group = c("total_surface","diatom_18sv9_surface"), basic = c("totals","18s_diatom"),
  ...
  all_alpha_gamma <- alpha_versus_gamma_figure(full_data_file = paste0("output/", in_group[1], "_full_data.Rdata"),
                                               ...
                                               map_file = paste0("output/", in_group[1], "_map.Rdata"), minimum_tp = 2,
  ...
  alpha_gamma <- alpha_versus_gamma_figure(full_data_file = paste0("output/", in_group[2], "_full_data.Rdata"),
                                           ...
                                           map_file = paste0("output/", in_group[2], "_map.Rdata"), minimum_tp = 2,
