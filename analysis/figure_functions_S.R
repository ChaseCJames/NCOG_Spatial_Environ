...
regression_figure <- function(glm_file = "output/bacteria_m_euks_16s_glm_S.Rdata",
                              map_file = "output/bacteria_m_euks_16s_map_S.Rdata",   
  ...
  pdf(file = paste0(figure_name,var,"_S.pdf"), width = 5, height = 3)
  print(reg_plot)
  dev.off()
...
aic_table_func <- function(som_maps = cyano_plots){  
  ...
  model_AIC[9,2] <- ct_sum$aic
  model_AIC[9,1] <- "Coeff. Var. Temp"
  model_AIC[9,3] <- coef(ct_sum)[2,4]
  ...
  model_AIC[10,1] <- "Coeff. Var. Salinity"
  ...
  model_AIC[3,3] <- coef(mn_sum)[2,4]
  
  glm_coeff_no3 <- glm(som_1 ~  NO3_coeff, data = som_glm, family = binomial)
  cn_sum <- summary(glm_coeff_no3)
  model_AIC[11,2] <- cn_sum$aic
  model_AIC[11,1] <- "Coeff. Var. NO3"
  model_AIC[11,3] <- coef(cn_sum)[2,4]
  ...
  model_AIC[4,1] <- "Mean PO4"
  model_AIC[4,3] <- coef(mp_sum)[2,4]
  
  glm_coeff_po4 <- glm(som_1 ~  PO4_coeff, data = som_glm, family = binomial)
  cp_sum <- summary(glm_coeff_po4)
  model_AIC[12,2] <- cp_sum$aic
  model_AIC[12,1] <- "Coeff. Var. PO4"
  model_AIC[12,3] <- coef(cp_sum)[2,4]
  ...
  model_AIC[5,1] <- "Mean SiO4"
  model_AIC[5,3] <- coef(ms_sum)[2,4]
  
  glm_coeff_sio3 <- glm(som_1 ~  SiO3_coeff, data = som_glm, family = binomial)
  cs_sum <- summary(glm_coeff_sio3)
  model_AIC[13,2] <- cs_sum$aic
  model_AIC[13,1] <- "Coeff. Var. SiO4"
  model_AIC[13,3] <- coef(cs_sum)[2,4]
  ...
  model_AIC[16,2] <- ms_sum$aic
  model_AIC[16,1] <- "Distance to Coast"
  model_AIC[16,3] <- coef(ms_sum)[2,4]
  ...
  model_AIC[17,1] <- "Coeff. Var. Chl-a"
...
aic_table_func_diveristy_sign <- function(som_maps = cyano_plots, col_num = 2){  
  ...
  model_AIC[9,2] <- ct_sum$aic
  model_AIC[9,1] <- "Coeff. Var. Temp"
  model_AIC[9,3] <- cor(som_glm$temp_coeff, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[9,4] <- coef(ct_sum)[2,4]
  ...
  model_AIC[2,2] <- mt_sum$aic
  model_AIC[2,1] <- "Mean Salinity"
  model_AIC[2,3] <- cor(som_glm$sal_mean, som_glm$response, use = "pairwise.complete.obs")
  ...
  model_AIC[10,2] <- ct_sum$aic
  model_AIC[10,1] <- "Coeff. Var. Salinity"
  model_AIC[10,3] <- cor(som_glm$sal_coeff, som_glm$response, use = "pairwise.complete.obs")
  ...
  model_AIC[3,2] <- mn_sum$aic
  model_AIC[3,1] <- "Mean NO3"
  model_AIC[3,3] <- cor(som_glm$NO3_mean, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[3,4] <- coef(mn_sum)[2,4]
  
  glm_coeff_no3 <- glm(response ~  NO3_coeff, data = som_glm)
  cn_sum <- summary(glm_coeff_no3)
  model_AIC[11,2] <- cn_sum$aic
  model_AIC[11,1] <- "Coeff. Var. NO3"
  model_AIC[11,3] <- cor(som_glm$NO3_coeff, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[11,4] <- coef(cn_sum)[2,4]
  ...
  model_AIC[4,2] <- mp_sum$aic
  model_AIC[4,1] <- "Mean PO4"
  model_AIC[4,3] <- cor(som_glm$PO4_mean, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[4,4] <- coef(mp_sum)[2,4]
  
  glm_coeff_po4 <- glm(response ~  PO4_coeff, data = som_glm)
  cp_sum <- summary(glm_coeff_po4)
  model_AIC[12,2] <- cp_sum$aic
  model_AIC[12,1] <- "Coeff. Var. PO4"
  model_AIC[12,3] <- cor(som_glm$PO4_coeff, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[12,4] <- coef(cp_sum)[2,4]
  ...
  model_AIC[5,2] <- ms_sum$aic
  model_AIC[5,1] <- "Mean SiO4"
  model_AIC[5,3] <- cor(som_glm$SiO3_mean, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[5,4] <- coef(ms_sum)[2,4]
  
  glm_coeff_sio3 <- glm(response ~  SiO3_coeff, data = som_glm)
  cs_sum <- summary(glm_coeff_sio3)
  model_AIC[13,2] <- cs_sum$aic
  model_AIC[13,1] <- "Coeff. Var. SiO4"
  model_AIC[13,3] <- cor(som_glm$SiO3_coeff, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[13,4] <- coef(cs_sum)[2,4]
  ...
  model_AIC[6,2] <- ms_sum$aic
  model_AIC[6,1] <- "Mean MLD"
  model_AIC[6,3] <- cor(som_glm$MLD_mean, som_glm$response, use = "pairwise.complete.obs")
  ...
  model_AIC[14,2] <- cs_sum$aic
  model_AIC[14,1] <- "Coeff. Var. MLD"
  model_AIC[14,3] <- cor(som_glm$MLD_coeff, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[14,4] <- coef(cs_sum)[2,4]
  ...
  model_AIC[7,2] <- ms_sum$aic
  model_AIC[7,1] <- "Mean NCD"
  model_AIC[7,3] <- cor(som_glm$NC_mean, som_glm$response, use = "pairwise.complete.obs")
  ...
  model_AIC[15,2] <- cs_sum$aic
  model_AIC[15,1] <- "Coeff. Var. NCD"
  model_AIC[15,3] <- cor(som_glm$NC_coeff, som_glm$response, use = "pairwise.complete.obs")
  ...
  model_AIC[16,2] <- ms_sum$aic
  model_AIC[16,1] <- "Distance to Coast"
  model_AIC[16,3] <- cor(som_glm$Dist_mean, som_glm$response, use = "pairwise.complete.obs")
  model_AIC[16,4] <- coef(ms_sum)[2,4]
  ...
  model_AIC[8,2] <- ms_sum$aic
  model_AIC[8,1] <- "Mean Chl-a"
  model_AIC[8,3] <- cor(som_glm$Chl_mean, som_glm$response, use = "pairwise.complete.obs")
  ...
  model_AIC[17,2] <- cs_sum$aic
  model_AIC[17,1] <- "Coeff. Var. Chl-a"
  model_AIC[17,3] <- cor(som_glm$Chl_coeff, som_glm$response, use = "pairwise.complete.obs")
