...
fig_1_rev_func <- function(in_temp = "output/CALCOFI_temp_tables.Rdata",
  ...
  stations <-  ggplot() + 
    ...
    geom_text(data = som_line, aes(x = x_coord - 0.44, y = y_coord - 0.05, label = line),
              hjust = 1, size = 1.7) +
    geom_point(data = som_maps %>% filter(!is.na(cardinal)), aes(x = long, y = lat, shape = cardinal),
               show.legend = TRUE, pch = 0 , size = 2) + 
    annotate(x = -126.95, y = 36.99, label = "a", size = 2.5, geom = "text", fontface = "bold") +
    ...
    scalebar(x.min = -127, x.max = -116, 
             ...
             transform = TRUE, location = "bottomright", st.dist = -0.05, height = 0.025,
             st.size = 1.6,  st.color = "black", border.size = 0.15, anchor = c(x = -116.5, y = 28.1)) +
    ...
    guides(fill = guide_colorbar(barwidth = 2.5, barheight = 0.4))
  ...
  depths <- ggplot() +
    ...
    annotate(x = 0, y = 0, label = "b", size = 2.5, geom = "text", fontface = "bold") +
    theme(panel.background = element_blank(),
          panel.border = element_rect(fill = NA,colour = "black", linetype = "solid"),
          plot.title = element_text(), axis.line = element_blank(),
          legend.justification=c(1,1), 
  ...
  sst_mean <- ggplot() + 
    ...
    geom_point(data = som_maps, aes_string(x = "long", y = "lat"),
               color = "grey90", fill = NA,size =psize, stroke = 0.5, shape = 21) +
    ...
    geom_polygon(data = map, aes(x=long, y = lat, group = group), fill = "grey", color = "black") + 
    coord_fixed(xlim = c(-127, -116),ylim= c(28,37), 1.3) +
    annotate(x = -126.95, y = 36.99, label = "d", size =2.5, geom = "label", fontface = "bold") +
    xlab("Longitude") + ylab("Latitude") +
    scale_x_continuous(breaks = c(-125,-122,-119)) +
    theme(panel.background = element_blank(),
          panel.border = element_rect(fill = NA,colour = "black", linetype = "solid"),
          ...
          legend.title = element_text(size = tsize-2),
          plot.margin = ggplot2::margin(1,1,1,1),
          legend.margin = ggplot2::margin(3,6,3,3),
          legend.direction = "horizontal") +
    guides(fill = guide_colorbar(barwidth = 2.5, barheight = 0.4))
  ...
  nc_depth <-  ggplot() + 
    ...
    xlab("Longitude") + ylab("Latitude") + 
    scale_x_continuous(breaks = c(-125,-122,-119)) +
    annotate(x = -126.95, y = 36.99, label = "c", size = 2.5, geom = "text", fontface = "bold") +
    ...
    theme(panel.background = element_blank(),
          ...
          legend.margin = ggplot2::margin(3,3,3,3),
          legend.direction = "horizontal") +
    guides(fill = guide_colorbar(barwidth = 2.7, barheight = 0.4))
...
fig_2_func <- function(in_list = plot_list, file_name = "figures_S/fig_2_S.pdf", tsize  = 7){
  ...
  in_list[[6]]$bp <- in_list[[6]]$bp + theme(axis.title.x = element_blank(),
                                             ...
                                             plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Archaea") +
    annotate(x = -126.95, y = 36.95, label = "a", size = 2.5, geom = "text", fontface = "bold") +
    annotate(x = -126.99, y = 28.2, label = "Offshore", size = 2.5, geom = "text", hjust = 0)
  ...
  in_list[[13]]$bp <- in_list[[13]]$bp + theme(axis.title.x = element_blank(),
                                               ...
                                               legend.position = "none",
                                               plot.background = element_blank(),
                                               plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle(" Bacteria") +
    annotate(x = -126.95, y = 36.95, label = "b", size = 2.5, geom = "text", fontface = "bold")
  ...
  in_list[[14]]$bp <- in_list[[14]]$bp + theme(axis.title.x = element_blank(),
                                               ...
                                               legend.position = "none",
                                               plot.background = element_blank(),
                                               plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Cyanobacteria")  +
    annotate(x = -126.95, y = 36.95, label = "c", size = 2.5, geom = "text", fontface = "bold")
  ...
  in_list[[16]]$bp <- in_list[[16]]$bp + theme(axis.title.x = element_blank(),
                                               ...
                                               legend.position = "none",
                                               plot.background = element_blank(),
                                               plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Photosynthetic eukaryotic\n protists") +
    annotate(x = -126.95, y = 36.97, label = "d", size = 2.5, geom = "text", fontface = "bold")
  ...
  in_list[[15]]$bp <- in_list[[15]]$bp + theme(axis.title.x = element_blank(),
                                               ...
                                               plot.background = element_blank(),
                                               plot.margin = ggplot2::margin(1,5,1,1)) + ggtitle("Heterotrophic\neukaryotic protists") +
    labs(tag = "Frequency") + annotate(x = -126.95, y = 36.95, label = "e", size = 2.5, geom = "text", fontface = "bold") +
    guides(fill = guide_colorbar(barheight = 4))
    
  in_list[[6]]$rp <- in_list[[6]]$rp + theme(legend.position = "none",
                                             plot.title = element_blank()) + 
    scale_x_continuous(breaks= scales::pretty_breaks(n=3)) +
    annotate(x = -126.99, y = 28.2, label = "Nearshore", size = 2.5, geom = "text", hjust = 0) 
  ...
  pdf(file = file_name, width = 7.08661, height = 3.2)
...
fig_3_func <- function(file_name = "figures_S/fig_3_S.pdf", tsize = 7){
  
  cyano <- regression_figure(glm_file = "output/cyano_16s_glm_S.Rdata",
                             map_file = "output/cyano_16s_map_S.Rdata",   
                             figure_name = "old_figures/figures/glm_plots/cyano_16s_som_",
  ...
  cyano <- cyano + ggtitle("") + 
    theme(legend.justification=c(1,0.5), 
          ...
          legend.margin = ggplot2::margin(0.1,2,4,4)) +
    annotate(x = 0, y = 1, geom = "text", label = "a", size = 2.5, fontface = "bold")
  ...
  aic_plot <- full_aic_table_figure(in_group_list = c("archaea_16s","bacteria_m_euks_16s", "cyano_16s","euks_auto_18sv9",
                                    ...
                                    figure_name_2 = paste0("old_figures/figures/aic_figures/big_group_aic_plot_logit",".pdf"),
                                    title_name = "Variable Importance")
  
  aic_plot <- aic_plot + ggtitle("") +
    theme(axis.title = element_blank(),
          axis.text.x = element_text(size = (tsize - 2)),
          plot.title = element_text(hjust = 0, size = tsize),
          plot.margin = ggplot2::margin(1,1,1,1)) +
    annotate(xmin = 0.4, ymin = 13.25, xmax = 0.6, ymax = 14.75, geom = "rect", fill = "white", color= "white") +
    annotate(x = 0.5, y = 14, geom = "text", label = "b", size = 2.5, fontface = "bold") +
    scale_size_continuous(range = c(0.2,7))
    
  
  a <- cyano + aic_plot + plot_layout(widths = c(1.15,2)) 
  
  pdf(file = file_name, width = 7.08661, height = 3.5)
  print(a)
  dev.off()
...
fig_4_func <- function(file_name = "figures_S/fig_4_S.pdf",
                       ...
                       name = c("All ASVs", "Diatoms"), tsize = 7){
  ...
  all_map <- diveristy_figure(map_file = paste0("output/", in_group[1], "_map_S.Rdata"),
                          ...
                          figure_start = paste0("old_figures/figures/diversity/", in_group[1], "_"),
                          main = name[1])
  ...
  all_alpha_gamma <- alpha_versus_gamma_figure(full_data_file = paste0("output/", in_group[1], "_full_data_S.Rdata"),
                                           ...
                                           figure_name = paste0("old_figures/figures/diversity/", in_group[1], "_alpha_gamma_S.pdf"),
                                           main = name[1])

  
  map <- diveristy_figure(map_file = paste0("output/", in_group[2], "_map_S.Rdata"),
                          full_dat = paste0("output/", in_group[2], "_full_data_S.Rdata"),
                          figure_start = paste0("old_figures/figures/diversity/", in_group[2], "_"),
                          main = name[2])
  ...
  alpha_gamma <- alpha_versus_gamma_figure(full_data_file = paste0("output/", in_group[2], "_full_data_S.Rdata"),
                                           ...
                                           figure_name = paste0("old_figures/figures/diversity/", in_group[2], "_alpha_gamma_S.pdf"),
                                           main = name[2])
  
  
  all_map <- all_map + 
    annotate(x = -126.95, y = 36.99, label = "a", size = 2.5, geom = "text", fontface = "bold") +
    annotate(x = -117.4, y = 36.99, label = "All ASVs", size = 2.5, geom = "text") +
    theme(plot.title = element_blank(),
          legend.justification=c(1,0), 
          legend.position=c(0.97, 0.03),
          legend.background = element_rect(fill = "white", color = "black", size = 0.15),
          ...
          legend.title = element_text(size = (tsize-2)),
          plot.margin = ggplot2::margin(2,1,1,1),
          legend.margin = ggplot2::margin(1,1,1,1),
          legend.direction = "horizontal") + 
    labs(fill = "Mean Alpha\nDiversity") +
    scale_x_continuous(breaks= scales::pretty_breaks(n=3)) +
    scale_fill_viridis(breaks = c(5.6,5.2,4.8)) +
    guides(fill = guide_colorbar(barwidth = 2, barheight = 0.25))
  
  all_alpha_gamma <- all_alpha_gamma + 
    annotate(x = 0, y = 7, label = "b", size = 2.5, geom = "text", fontface = "bold") +
    annotate(x = 300, y = 7, label = "All ASVs", size = 2.5, geom = "text") +
    theme(plot.title = element_blank(),
          legend.justification=c(1,0), 
  ...
  map <- map + 
    annotate(x = -126.95, y = 36.99, label = "c", size = 2.5, geom = "text", fontface = "bold") +
    annotate(x = -117.4, y = 36.99, label = "Diatoms", size = 2.5, geom = "text") +
    theme(plot.title = element_blank(),
          legend.justification=c(1,0), 
          legend.position=c(0.97, 0.03),
          legend.background = element_rect(fill = "white", color = "black", size = 0.15),
  ...
  alpha_gamma <- alpha_gamma + 
    annotate(x = 0, y = 4.35, label = "d", size = 2.5, geom = "text", fontface = "bold") +
    annotate(x = 300, y = 4.35, label = "Diatoms", size = 2.5, geom = "text") +
    theme(plot.title = element_blank(),
  ...
  out_plot <- full_aic_table_figure_diversity_sign(in_group_list = c("archaea_16s",
                                                   ...
                                                   in_group_names = c("Archaea","Bacteria", 
                                                                      ...
                                                                      "Heterotrophic\nEukaryotic\nProtists"),
                                                   figure_name_2 = NULL,
                                                   col = 25, width_plot = 12, tsize = 5)
  
  
    out_plot <- out_plot +
    annotate(xmin = 0.4, ymin = 13.25, xmax = 0.6, ymax = 14.75, geom = "rect", fill = "white", color= "white") +
    annotate(x = 0.5, y = 14, geom = "text", label = "e", size = 2.5, fontface = "bold") +
      theme(plot.margin = ggplot2::margin(1,1,1,1),
            legend.margin = ggplot2::margin(1,1,5,1),
      ...
      scale_size_continuous(range = c(0.2,7), guide = FALSE) +
      guides(fill = guide_colorbar(barwidth = 6, barheight = 0.6))
  ...
  pdf(file = file_name, width =  7.08661, height = 3.8)
  print(plots)
  dev.off()
...
fig_5_func <- function(in_upwell = "output/upwelling_plots.Rdata",
                       ...
                       tsize = 7, psize = 1.7, in_list = fig_list){
  ...
  yearly_cuti <- yearly_cuti + theme(plot.title = element_text(size = tsize),
    ...
    annotate(x = 1, y = 1, geom = "text", size = 2.5, fontface = "bold", label = "a")
  ...
  yearly_beuti <- yearly_beuti + theme(plot.title = element_text(size = tsize),
    ...
    annotate(x = 1, y = 8.1, geom = "text", size = 2.5, fontface = "bold", label = "b")
  ...
  yearly_nitrate <- yearly_nitrate + theme(plot.title = element_text(size = tsize),
    ...
    ylab("BEUTI/CUTI") +
    annotate(x = 1, y = 8.3, geom = "text", size = 2.5, fontface = "bold", label = "c") +
  ...
  early_n <- ggplot() + 
    ...
    scale_x_continuous(breaks = c(-125,-122,-119)) + 
    annotate(x = -126.95, y = 36.99, label = "d", size = 2.5, geom = "text", fontface = "bold")  +
  ...
  late_n <- ggplot() + 
    ...
    scale_x_continuous(breaks = c(-125,-122,-119)) + 
    annotate(x = -126.95, y = 36.99, label = "e", size = 2.5, geom = "text", fontface = "bold") +
    guides(fill = guide_colorbar(barwidth = 2.5, barheight = 0.5))
  ...
  diff_n <- ggplot() + 
    ...
    scale_x_continuous(breaks = c(-125,-122,-119)) + 
    annotate(x = -126.95, y = 36.99, label = "f", size = 2.5, geom = "text", fontface = "bold") +
    guides(fill = guide_colorbar(barwidth = 2.5, barheight = 0.5))
  ...
  arch <- (in_list[[6]]$surf + ggtitle("Archaea") +
    ...
    annotate(x = -126.95, y = 36.99, label = "g", size = 2.5, geom = "text", fontface = "bold") +
    scale_x_continuous(breaks = c(-125,-122,-119)) +
    annotate(geom = "text", x = -116.03, y = 36.99, label = "Surface\n(2014-2016) vs\n(2017-2018)",
             hjust = 1, size = 1.7, vjust = 1)
    ...
    bact <- (in_list[[13]]$surf + ggtitle("Bacteria") +
       ...
       theme(axis.title.y = element_blank(),
         ...
         theme(legend.position = "none",
               plot.margin = ggplot2::margin(1,2,2,2))) + 
      annotate(x = -126.95, y = 36.99, label = "h", size = 2.5, geom = "text", fontface = "bold") +
      scale_x_continuous(breaks = c(-125,-122,-119)) +
      annotate(geom = "text", x = -116.03, y = 36.99, label = "Surface\n(2014-2016) vs\n(2017-2018)",
               hjust = 1, size = 1.7, vjust = 1)
    ...
    cyano <- (in_list[[14]]$surf + ggtitle("Cyanobacteria") +
       ...
       theme(axis.title.y = element_blank(),
         ...
         theme(legend.position = "none",
               plot.margin = ggplot2::margin(1,2,2,2))) + 
      annotate(x = -126.95, y = 36.99, label = "i", size = 2.5, geom = "text", fontface = "bold") +
      scale_x_continuous(breaks = c(-125,-122,-119)) +
      annotate(geom = "text", x = -116.03, y = 36.99, label = "Surface\n(2014-2016) vs\n(2017-2018)",
               hjust = 1, size = 1.7, vjust = 1)
    ...
    photo <- (in_list[[16]]$surf + ggtitle("Photosynthetic Eukaryotic\nProtists") +
       ...
       theme(axis.title.y = element_blank(),
         ...
         theme(legend.position = "none",
               plot.margin = ggplot2::margin(1,2,2,2))) + 
      annotate(x = -126.95, y = 36.99, label = "j", size = 2.5, geom = "text", fontface = "bold") +
      scale_x_continuous(breaks = c(-125,-122,-119)) +
      annotate(geom = "text", x = -116.03, y = 36.99, label = "Surface\n(2014-2016) vs\n(2017-2018)",
               hjust = 1, size = 1.7, vjust = 1)
    ...
    hetero <- (in_list[[15]]$surf + ggtitle("Heterotrophic Eukaryotic\nProtists") +
       ...
       theme(axis.title.y = element_blank(),
             ...
             legend.background = element_rect(fill = "white", color = "black", size = 0.15),
             plot.margin = ggplot2::margin(1,2,2,2),
             legend.margin = ggplot2::margin(1,5,1,2)))+ 
      annotate(x = -126.95, y = 36.99, label = "k", size = 2.5, geom = "text", fontface = "bold") +
      scale_x_continuous(breaks = c(-125,-122,-119)) +
      guides(fill = guide_colorbar(barwidth = 2.6, barheight = 0.5)) +
      annotate(geom = "text", x = -116.03, y = 36.99, label = "Surface\n(2014-2016) vs\n(2017-2018)",
               hjust = 1, size = 1.7, vjust = 1)
  ...
  pdf(file = time_plot, width = 7.08661, height = 7.28346)
  print(plot1)
  dev.off()
...
fig_6_func <- function(in_phyto = "output/euks_auto_18sv9_diffs_S.Rdata",
  ...
  sub_a <- ggplot(wint_pie, aes(x="", y=prop, fill=som_id)) +
    ...
    theme_void() + 
    theme(legend.position="none") +
    geom_text(aes(y = ypos, label = count), color = "white", size=1.7, fontface = "bold") +
  ...
  a <- ggplot() +
    ...
    annotate(geom = "text", x = 50, y = 135, label = "Winter 2015", size = 2.5) +
    annotate(geom = "text", x = 368, y = 0, label = "a", size = 2.5, fontface= "bold") +
    theme(panel.background = element_blank(),
  ...
  b <- ggplot() +
    ...
    # scale_color_gradient(high = "dodgerblue3", low = "steelblue1") +
    # annotate(geom = "text", x = 184.5, y = -6, label = "surface", size = 5) +
    annotate(geom = "text", x = 50, y = 135, label = "Summer 2019", size = 2.5) +
    annotate(geom = "text", x = 368, y = 0, label = "b", size = 2.5, fontface= "bold") +
    theme(panel.background = element_blank(),
          panel.border = element_rect(fill = NA, color = "black"),
          legend.title = element_blank(),
 ...
 b_sch <- ggplot() +
  ...
  phyto_gradient <- phyto_gradient + theme(legend.position = "none") +  
    ...
    theme(axis.text.x  = element_blank(),
          ...
          legend.text = element_text(size = tsize),
          legend.position = "none",
          plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Photosynthetic eukaryotic protists") +
    annotate(x = 0.17, y = 0.64, geom = "text", label = "c", fontface = "bold", size = 2.5)
  ...
  euk_gradient <- euk_gradient + theme(legend.position = "none") + 
    theme(axis.text.x  = element_blank(),
          ...
          axis.title = element_blank(),
          legend.position = "none",
          plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Heterotrophic eukaryotic protists") +
    annotate(x = 0.17, y = 0.77, geom = "text", label = "d", fontface = "bold", size = 2.5)
  ...
  cyano_gradient <- cyano_gradient + theme(legend.position = "none")  + 
    ...
    theme(plot.title = element_text(hjust=0, size = tsize),
          ...
          legend.key = element_blank(),
          plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Cyanobacteria") +
    annotate(x = 0.17, y = 0.675, geom = "text", label = "e", fontface = "bold", size = 2.5)
  ...
  bact_gradient <- bact_gradient +
    theme(axis.title.y = element_blank(),
          ...
          legend.key = element_blank(),
          plot.margin = ggplot2::margin(1,1,1,1),
          legend.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Bacteria") +
    xlab("Nearshore-Offshore\nSlope in Nitracline (m/km)") +
    annotate(x = 0.17, y = 0.71, geom = "text", label = "f", fontface = "bold", size = 2.5) +
    guides(fill = guide_legend(keywidth = 0.75, keyheight = 0.75),
           shape = guide_legend(keywidth = 0.75, keyheight = 0.75))
  ...
  arch_gradient <- arch_gradient +
    theme(axis.title.y = element_blank(),
          ...
          plot.margin = ggplot2::margin(1,1,1,1)) + ggtitle("Archaea") +
    xlab("Nearshore-Offshore\nSlope in Nitracline (m/km)") +
    annotate(x = 0.17, y = 0.7, geom = "text", label = "g", fontface = "bold", size = 2.5)
  ...
  pdf(file = gradient_plot_file, width = 7.08661, height = 7.08661)
  print(grad_plot)
  dev.off()
...
suppl_fig_2_func <- function(in_ncog = "data/all_18Sv9_rare.Rdata",
  ...
  split_taxa$endemic[which(split_taxa$CalCOFI == 0 & split_taxa$Tara == 1 & split_taxa$Polar == 0)] <- "Tara Oceans"
  ...
  colors <- c("#87bb37","#5362da","#4ec253","#aa60d9",
  ...
  split_taxa$endemic[which(split_taxa$CalCOFI == 1 & split_taxa$Tara == 1 & split_taxa$Polar == 0)] <- "NCOG + Tara Oceans"
  split_taxa$endemic[which(split_taxa$CalCOFI == 1 & split_taxa$Tara == 0 & split_taxa$Polar == 1)] <- "NCOG + Tara Polar"
  split_taxa$endemic[which(split_taxa$CalCOFI == 0 & split_taxa$Tara == 1 & split_taxa$Polar == 1)] <- "Tara Oceans + Tara Polar"
